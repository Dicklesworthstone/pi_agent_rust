    ...
    fn parameters(&self) -> Value {
        json!({
            ...
            "properties": {
                ...
                "query":{"type":"string","description":"Workspace-symbol query, fresh nonempty code-action title/index selection (preview unless apply:true), or case-sensitive completion filterText/label prefix (at most 128 bytes)"},
