    ...
    fn parameters(&self) -> Value {
        json!({
            ...
            "properties": {
                ...
                "refactorId":{"type":"string","maxLength":128,"description":"Opaque plan from rename or rename_file with apply:false. Use the same action and apply:true to consume and commit it; omit apply to inspect it again. No other selectors are accepted. Expires after five minutes, reload or another fresh rename. Every read preimage must remain unchanged."},
                ...
                "apply":{"type":"boolean","description":"Apply a selected code action/completion or formatting. Fresh rename/rename_file apply immediately unless false, which stages a preview. A selected refactorId writes only with true."},
