...
describe("skills", () => {
  describe("loadSkillsFromDir", () => {
    ...
    it("should warn when name contains invalid characters", () => {
      ...
      expect(skills).toHaveLength(1);
      expect(
        diagnostics.some((d: ResourceDiagnostic) => d.message.includes("invalid characters")),
      ).toBe(true);
    });
    ...
    it("should warn when name exceeds 64 characters", () => {
      ...
      expect(skills).toHaveLength(1);
      expect(
        diagnostics.some((d: ResourceDiagnostic) => d.message.includes("exceeds 64 characters")),
      ).toBe(true);
    });
    ...
    it("should warn and skip skill when description is missing", () => {
      ...
      expect(
        diagnostics.some((d: ResourceDiagnostic) => d.message.includes("description is required")),
      ).toBe(true);
    });
    ...
    it("should warn when unknown frontmatter fields are present", () => {
      ...
      expect(
        diagnostics.some((d: ResourceDiagnostic) =>
          d.message.includes('unknown frontmatter field "author"'),
        ),
      ).toBe(true);
      expect(
        diagnostics.some((d: ResourceDiagnostic) =>
          d.message.includes('unknown frontmatter field "version"'),
        ),
      ).toBe(true);
    });
    ...
    it("should warn when name contains consecutive hyphens", () => {
      ...
      expect(skills).toHaveLength(1);
      expect(
        diagnostics.some((d: ResourceDiagnostic) => d.message.includes("consecutive hyphens")),
      ).toBe(true);
    });
  ...
  describe("loadSkills with options", () => {
    ...
    it("should warn when skill path does not exist", () => {
      ...
      expect(skills).toHaveLength(0);
      expect(
        diagnostics.some((d: ResourceDiagnostic) => d.message.includes("does not exist")),
      ).toBe(true);
    });
